...
- **[Creation of the portfolio template]**
- **[Positioning elements using a flexbox and css grid]**
...
- [Live Demo Link](https://yegonkimutai.github.io/Portfolio)
...
This project is useful and important as it gives developers an experience of how personal portfolio should be created and displayed in different screens.
...
```sh
  cd my-folder
  git clone https://github.com/yegonkimutai/Portfolio-project
```
